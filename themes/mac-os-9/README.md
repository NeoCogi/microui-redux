...
`tools/xtask/src/bin/mac-os-9-theme-export.rs`. Regenerate the complete source set from the repository root with:

```sh
cargo run -p microui-redux-tools --bin mac-os-9-theme-export -- --output-dir themes/mac-os-9
```
