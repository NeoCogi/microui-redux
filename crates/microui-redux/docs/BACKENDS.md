...
use microui_redux_renderer_wgpu::WgpuRenderer as SelectedBackend;
...
The complete, documented [backend-frame cube demo](../../../demos/basic/src/bin/backend-frame-cube.rs)
