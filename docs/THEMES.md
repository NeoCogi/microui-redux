...
`minimize_side`, `maximize_side`, `vertical_spacing`, `minimum_extent`, `inner_spacing`, and
...
`vertical_spacing` is the exact title-field clearance applied equally above and below every square
caption button.
