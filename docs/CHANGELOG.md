...
- [x] Added one backend-neutral Windows-style keyboard contract.
    ...
    - [x] Focused control/menu visuals identify the keyboard target; active title and frame states identify the active window without an out-of-band effect pass.
- [x] Completed reusable retained scrolling and unified skin ownership.
    ...
    - [x] One Context-owned skin consistently styles window chrome, menus, containers, and widgets.
